...
--------|-------|------------|-------------|------------|---------|------|-------
Cleric  |     1 | Lizardfolk | Outlander   | Neutral    | PHB+VGM | 0    | 300
...
mod     | +1     | +3      | +3      | +0      | +4      | +0
prof    | +3     | +5      | +5      | +2      | +6      | +2
save    | +1     | +3      | +3      | +0      | +6/p    | +2/p
score   | 12     | 16      | 16      | 10      | 19      | 9
...
* Weapons Attacks:
  - Bite (Lizard folk, unarmed strike)
    - hit: d20+3 (1 + 3) [str + proficiency]
    - dmg: d6+1 (1) [str] piercing
  - Mace
    - hit:
    - dmg:
  - Light Crossbow (range)
    - hit:
    - dmg:
...
* Feats
  - Observant (cleric 4)
    - +1 Wis
    - read lips (common, goblin, draconic)
...
staff                             |   1  |   4    |
belt with 5 scabbards             |   1  |   1    | weight guess
  daggers                         |   5  |   5    | range 20/60
...
* House Rule: Spell points
    ...
    - current: 43 (poh)
               ...
               32 (3 * animate dead)
               29 (animate dead)
               28 (bless, du lang, kevel, shrathe)
               25 (spirit guardians)
